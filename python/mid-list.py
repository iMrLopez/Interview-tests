# Bienvenido al proceso de seleccion para la posicion de Python!
...
# Dadas dos listas, cree una tercera lista eligiendo todos los elementos de indice impar en la primera lista y los de indice par de la segunda lista y posteriormente ordenandolos de menor a mayor, no deben existir duplicados
